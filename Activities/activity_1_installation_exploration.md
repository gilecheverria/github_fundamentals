...
![git version](.images/1_git_version.png)
...
![git config](.images/1_git_config.png)
...
![Github signup](.images/1_git_hub_signup.png)

3. Enter de information that is prompted on screen:

![Github account](.images/1_git_hub_account.png)
...
![Github interests](.images/1_git_hub_account_interests.png)

6. Then, select the free github plan:

![Free plan](.images/1_git_hub_account_free_plan.png)
...
![Github dashboard](.images/1_git_hub_dashboard.png)

### Explore github

Here is an overview of the dashboard screen:

![Github dashboard explained](.images/1_git_hub_dashboard_explained.png)
...
![github add key](.images/1_git_hub_add_key.png)
